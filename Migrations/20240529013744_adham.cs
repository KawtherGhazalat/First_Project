        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    SectionName = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    Recipeitemid = table.Column<decimal>(type: "DECIMAL(18, 2)", nullable: false),
                    Recipeid = table.Column<decimal>(type: "DECIMAL(18, 2)", nullable: true),
                    Ingredient = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Items = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    ...
                    OrderRequester = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    RecipeId = table.Column<decimal>(type: "DECIMAL(18, 2)", nullable: false),
                    Title = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    Description = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    CreationDate = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    ...
                    UserId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    isSold = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    CategoryId = table.Column<int>(type: "NUMBER(10)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    Dateposted = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Testimonials", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Testimonials_Recipes_RecipeId",
                        column: x => x.RecipeId,
